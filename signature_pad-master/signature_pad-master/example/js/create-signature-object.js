...
/// Edited by Matthew Babb 12/4/18
...
function createDataObject(signature_status, Blob) {
    var current_time = convertUTCDateToLocalDate(new Date()); // Gets the current time stamp
...
// PARAMETER(S):
// date: A javascript date object based in UTC time
// RETURNS:
// Given a javascript date object, the function will return the location adjusted date object
// *2 
...
// 
// 2.  URL: https://stackoverflow.com/questions/6525538/convert-utc-date-time-to-local-date-time
//      POSTED BY: https://stackoverflow.com/users/1022459/adorjan-princz